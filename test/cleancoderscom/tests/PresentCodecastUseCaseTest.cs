...
namespace cleancoderscom.tests.presentation
{
    ...
    ///   It was used iheritance to permit access to context field variables. 
    ///   Classes that have subclasses should have no tests and should work only as container of subclasses with tests.   
    /// </summary>
